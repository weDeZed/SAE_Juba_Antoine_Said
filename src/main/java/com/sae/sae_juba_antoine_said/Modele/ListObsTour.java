    ...
    public void onChanged(Change<? extends Tour> t) {
        ...
        while (t.next()) {
            ...
            for (Tour tour : t.getAddedSubList()) {
                ...
                try {
                    fichierGuerrier = new FileInputStream("C:\\Users\\jubac\\Desktop\\Programmation\\S2\\TP JAVA\\SAE_Juba_Antoine_Said\\src\\main\\java\\com\\sae\\sae_juba_antoine_said\\Ressources\\tour.png");
                } catch (Exception e) {
                    e.printStackTrace();
                }
